...
public class LoginAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    Toast.makeText(LoginAccount.this, "Welcome back", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(LoginAccount.this, MainActivity.class);
                    startActivity(i);
                    finish();
                } else{
                    Toast.makeText(LoginAccount.this, "firebase user -"+mFirebaseUser, Toast.LENGTH_SHORT).show();
                }
            }
        };
        /////////////
        ...
        createaccLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(LoginAccount.this, CreateAccount.class);
                startActivity(i);
            }
        });
        /////////////////
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(LoginAccount.this, new OnCompleteListener<AuthResult>() {
                    @Override
                            ...
                            typeref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    if(documentSnapshot.exists()){
                                        Toast.makeText(LoginAccount.this, "Logged in Successfully as " +email, Toast.LENGTH_SHORT).show();
